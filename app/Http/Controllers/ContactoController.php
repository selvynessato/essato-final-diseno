...
class ContactoController extends Controller
{
    public function create()
    {
        ...
        return view('contacto.create', compact('paises', 'departamentos', 'encontraressatos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $contacto = new Contacto(); // Crear una nueva instancia de Contacto
        ...
        $contacto->comoEncontraste_contacto = $request->input('Encontraressato_contacto');
        $contacto->mensaje_contacto = $request->input('mensaje_contacto');
    
        $contacto->save(); // Guardar el contacto en la base de datos
