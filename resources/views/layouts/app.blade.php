                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ url('/contacto/encontrar-essato') }}">
                                        Encontraste
                                    </a>                                  
                                    <a class="dropdown-item" href="{{ url('/contacto/mensaje-essato') }}">
                                        Contacto
                                    </a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ url('empresa/tipo_empresa') }}">
                                        Tipo de empresa
                                    </a>                                  
                                    <a class="dropdown-item" href="{{ url('empresa/actividad') }}">
                                        Actividad
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        Testimonio
                                    </a>
                                    <a class="dropdown-item" href="{{ url('empresa/empresa_negocio') }}">
                                        Empresa
                                    </a>
                                </div>
                            </li>
